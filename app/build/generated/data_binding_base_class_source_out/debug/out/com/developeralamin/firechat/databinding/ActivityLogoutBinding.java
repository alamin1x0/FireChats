...
public final class ActivityLogoutBinding implements ViewBinding {
  ...
  private ActivityLogoutBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivityLogoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLogoutBinding((ConstraintLayout) rootView, textView);
    }
