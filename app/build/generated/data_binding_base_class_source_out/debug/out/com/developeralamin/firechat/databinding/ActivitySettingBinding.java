...
public final class ActivitySettingBinding implements ViewBinding {
  ...
  private ActivitySettingBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivitySettingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySettingBinding((ConstraintLayout) rootView, textView);
    }
